...
func getMemoryTypeName(memType memoryTypeEnumAttr) (string) {
    switch memType {
        case memoryTypeEnum.memoryTypeUnknown: return "unknown"
        case memoryTypeEnum.memoryTypeDDR4: return "ddr4"
        case memoryTypeEnum.memoryTypeNVMDIMM: return "nvm"
    }
    return "unknown"
}
...
func getLockstateName(lockState lockStateEnumAttr) (string) {
    switch lockState {
        case lockStateEnum.lockStateUnknown: return "unknown"
        case lockStateEnum.lockStateDisable: return "disable"
        case lockStateEnum.lockStateUnlocked: return "unlocked"
        case lockStateEnum.lockStateLocked: return "locked"
        case lockStateEnum.lockStateFrozen: return "frozen"
        case lockStateEnum.lockStatePassphraseLimit: return "passphrase_limit"
        case lockStateEnum.lockStateNotSupported: return "not_supported"
    }
    return "unknown"
}
...
func getManageabilityName(manageability manageabilityStateEnumAttr) (string) {
    switch manageability {
        case manageabilityStateEnum.managementUnknown: return "unknown"
        case manageabilityStateEnum.managementValidConfig: return "valid_config"
        case manageabilityStateEnum.managementInvalidConfig: return "invalid_config"
        case manageabilityStateEnum.managementNonFunctional: return "non_functional"
    }
    return "unknown"
}
